...
use rooch_finality_gadget::msg::{ExecuteMsg, InstantiateMsg, QueryMsg};
use rooch_finality_gadget::state::config::Config;

static WASM: &[u8] = include_bytes!("../../../artifacts/rooch_finality_gadget.wasm");
...
fn instantiate_works() {
    ...
    let msg = InstantiateMsg {
        ...
        consumer_id: "rooch-l2-11155420".to_string(),
        is_enabled: false,
    };
